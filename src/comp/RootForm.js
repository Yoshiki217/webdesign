                    ...
                    <div class='flex flex-wrap -mx-3 mb-6'>
                        ...
                        <div class="personal w-full border-t border-gray-400 pt-4">
                            ...
                            <div class='w-full md:w-full px-3 mb-6'>
                                ...
                                <textarea class='bg-gray-100 rounded-md border leading-normal resize-none w-full h-20 py-2 px-3 shadow-inner  border-gray-400 font-medium placeholder-gray-700 focus:outline-none focus:bg-white'  required></textarea>
                            </div>
